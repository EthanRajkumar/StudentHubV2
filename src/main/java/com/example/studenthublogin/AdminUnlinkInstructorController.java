...
public class AdminUnlinkInstructorController extends SceneController {

    @FXML
    private VBox adminUnlinkInstructorVBox;
    ...
    @FXML
    protected void onUnlink() throws SQLException {
        ...
        Admin.UninkInstructorFromCourse(crnInput);
        resultMsg.setText("Instructor successfully unlinked from course.");
        courseTable.setItems(FXCollections.observableList(User.GetAllCourses()));
    }
}
