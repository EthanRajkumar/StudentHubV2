...
public class AdminRegisterStudentController extends SceneController {
    ...
    @FXML
    protected void onRegister() throws SQLException {
        ...
        Admin.AddStudentToCourse(studentInput, crnInput);
        resultMsg.setText("Student successfully added to course.");
        courseTable.setItems(FXCollections.observableList(User.GetAllCourses()));
    }
}